...
const ProductsPageModules = () => {
  ...
  return (
    <div>
      <div className="h-screen">
        ...
        <div className="absolute inset-0 flex items-center justify-center ">
          <div className="w-[80%] flex flex-col items-center justify-between">
            <h1 className="text-white text-[60px] font-bold text-center font-bell-mt text-shadow shadow-gray-700">
              Products
            </h1>
      ...
      >
        <h1 className="flex font-bell-mt text-center text-3xl sm:text-[50px] font-bold text-white">
          Our collection
        </h1>
      ...
      <div className="flex my-10 flex-col justify-center py-5 sm:py-20 items-center gap-10">
        <h1 className="flex font-bell-mt text-center text-4xl sm:text-[50px] font-bold text-navy-blue">
          All products
        </h1>
